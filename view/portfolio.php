  ...
  <nav class="bg-gray-900 sticky top-0 z-50">
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
      ...
      <div class="hidden md:flex space-x-6">
        <a href="#" class="text-white hover:text-blue-400"><i class="fas fa-home"></i> Home</a>
        <a href="#about" class="text-white hover:text-blue-400"><i class="fas fa-user"></i> About Me</a>
        <a href="#projects" class="text-white hover:text-blue-400"><i class="fas fa-project-diagram"></i> Projects</a>
        <a href="#contact" class="text-white hover:text-blue-400"><i class="fas fa-envelope"></i> Contact Me</a>
        <a href="update_profile.php" class="text-white hover:text-blue-400"><i class="fas fa-user-edit"></i> Update Profile</a>
        <a href="../login.php" class="text-white hover:text-red-400"><i class="fas fa-sign-out-alt"></i> Log Out</a>
      </div>
    </div>
  </nav>

  <!-- Hero Section -->
  <section class="bg-gray-800 text-center py-16 px-4">
    <div class="max-w-4xl mx-auto">
      <h3 class="text-xl">Hi! I'm</h3>
      <h1 class="text-4xl font-bold">John Doe</h1>
      <h1 class="text-2xl mt-2">Web Developer & Designer</h1>
      <div class="mt-6">
        <a href="#about" class="bg-blue-500 hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded">Learn More about Me</a>
      </div>
    </div>
    <div class="mt-8">
      <img src="../upload/profile.jpg" alt="Profile Picture" class="mx-auto rounded-full w-48 h-48 object-cover" />
    </div>
  </section>
